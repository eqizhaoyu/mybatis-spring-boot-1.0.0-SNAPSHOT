...
/* 209 */       .getSubsection(entry
/* 209 */       .getLocalHeaderOffset(), 30L));
...
/* 219 */     FileHeader entry = getEntry(hashCode, name, "", type, cacheEntry);
/* 220 */     if (entry == null) {
...
/* 231 */       FileHeader entry = getEntry(index, type, cacheEntry);
...
/*     */ 
/* 246 */       FileHeader entry = cached != null ? cached : 
/* 246 */         CentralDirectoryFileHeader.fromRandomAccessData(this.centralDirectoryData, this.centralDirectoryOffsets[index], this.filter);
/*     */ 
/* 249 */       if ((CentralDirectoryFileHeader.class.equals(entry.getClass())) && 
/* 250 */         (type
/* 250 */         .equals(JarEntry.class)))
/*     */       {
 ...
 * Qualified Name:     org.springframework.boot.loader.jar.JarFileEntries
