...
/*    */ 
/* 72 */       dataOffset = dataOffset + (this.CENTRAL_DIRECTORY_HEADER_BASE_SIZE + fileHeader
/* 71 */         .getName().length() + fileHeader.getComment().length() + fileHeader
/* 72 */         .getExtra().length);
/*    */     }
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.springframework.boot.loader.jar.CentralDirectoryParser
