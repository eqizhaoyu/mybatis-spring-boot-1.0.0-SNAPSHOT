...
/*  97 */       if (endIndex != -1)
/*     */       {
/*  99 */         String placeholder = buf
/*  99 */           .substring(startIndex + "${"
/*  99 */           .length(), endIndex);
/* 100 */         String originalPlaceholder = placeholder;
/* 101 */         if (!visitedPlaceholders.add(originalPlaceholder)) {
/* 102 */           throw new IllegalArgumentException(new StringBuilder().append("Circular placeholder reference '").append(originalPlaceholder).append("' in property definitions").toString());
/*     */         }
/*     */ 
...
/*     */ 
/* 118 */             String defaultValue = placeholder
/* 118 */               .substring(separatorIndex + ":"
/* 118 */               .length());
...
/*     */     catch (Throwable ex)
/*     */     {
/* 198 */       System.err.println(new StringBuilder().append("Could not resolve key '").append(key).append("' in '").append(text).append("' as system property or in environment: ").append(ex).toString());
/*     */     }
/*     */ 
...
/* 211 */           index += "}".length(); continue;
/*     */         }
/*     */ 
/* 214 */         return index;
/*     */       }
/*     */ 
/* 217 */       if (substringMatch(buf, index, SIMPLE_PREFIX)) {
/* 218 */         withinNestedPlaceholder++;
/* 219 */         index += SIMPLE_PREFIX.length(); continue;
/*     */       }
/*     */ 
/* 222 */       index++;
/*     */     }
 ...
 * Qualified Name:     org.springframework.boot.loader.util.SystemPropertyUtils
